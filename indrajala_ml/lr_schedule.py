...
def linear_warmup(target_rate: float, warmup_steps: int) -> Callable[[int], float]:
    ...
    docs/learning-rate-schedule.md for the concrete failure case this targets:
    ...
    iteration entirely, learning nothing. See docs/learning-rate-schedule.md's own "design"
