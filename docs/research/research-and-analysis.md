...
drove a choice, not just the choice itself. Unlike [structure](../project/structure.md) (what the code does
now) or [demos](../project/demos.md) (what each demo shows), this is where the *why* lives, condensed to the
...
[structure](../project/structure.md#backprop-siblings) for its design).
