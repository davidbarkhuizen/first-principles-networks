...
The investigation thread behind [the Rust production cutover](../architecture/rust-production-cutover.md)'s
...
[The production cutover plan](../architecture/rust-production-cutover.md)'s own gating benchmark measured the
...
one-line fix - see the `cli` script and [setup](../project/setup.md)) - a benchmark's headline number is only
...
production cutover plan](../architecture/rust-production-cutover.md#risks-and-open-questions)'s own "risks and
...
[the production cutover plan](../architecture/rust-production-cutover.md#the-decisive-finding-this-plan-has-to-answer-first)
...
means seeds can't be matched across classes - see [the Rust core](../architecture/rust-array-core.md#the-rng-exception) -
...
[structure](../project/structure.md#possible-next-steps)): release-profile/codegen tuning, the cheapest
...
[vectorized array-based classes](../architecture/vectorized-array-classes.md#numerical-parity-validation)), not a
