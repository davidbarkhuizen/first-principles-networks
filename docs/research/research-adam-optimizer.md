...
The measurement results for `AdamBackpropClassifierNetwork` (see [structure](../project/structure.md#backprop-siblings)
...
descent](../features/mini-batch-gradient-descent.md)) - the practical payoff would come from pairing this
result with the array-based, Rust-matmul-backed Adam sibling flagged in
[structure](../project/structure.md#possible-next-steps) ("deepening what's already here"): genuine batched
...
[the Rust core](../architecture/rust-array-core.md#the-rng-exception)) but the same qualitative flat-across-batch
