...
[vectorized array-based classes](../architecture/vectorized-array-classes.md#measured-results), checked live
...
[the production cutover plan](../architecture/rust-production-cutover.md)), the Rust-array-core-backed sibling
...
analysis](../research/research-rust-performance.md#phase-2-tier-2-real-per-example-training-is-a-genuine-win-at-both-scales-measured)'s
...
[research and analysis](../research/research-multiclass-and-loss.md#parallelizing-mnist-training). One-time setup:
...
analysis](../research/research-multiclass-and-loss.md#the-ensemblereal-mnist-investigation)). Saves the trained
...
same architecture [research and analysis](../research/research-multiclass-and-loss.md#parallelizing-mnist-training)'s
...
plan](../architecture/rust-production-cutover.md)), the Rust-array-core-backed sibling that replaces numpy as the
...
comparisons [research and analysis](../research/research-and-analysis.md) documents from one-off,
...
- **Multi-class loss function** - `MultiClassBackpropClassifierNetwork` (one-vs-rest, MSE) vs
  ...
  (see [research and analysis](../research/research-multiclass-and-loss.md#softmaxcross-entropy-re-alignment)).
- **Binary loss function** - `BackpropClassifierNetwork` (quadratic) vs
  ...
  [research and analysis](../research/research-multiclass-and-loss.md#binary-cross-entropy-for-backpropclassifiernetwork)).
- **Weight-init scheme** - this codebase's fan-in-aware production default vs a Xavier/Glorot
  ...
  [research and analysis](../research/research-backprop-siblings.md#xavierglorot-init-measured-not-worth-adopting)),
  on UCI digits.
