...
([research and analysis](../research/research-and-analysis.md)).
...
- **Every addition has a real measurement behind it**, positive or negative, recorded honestly in
  [research and analysis](../research/research-and-analysis.md) - not "this should help" left unchecked.
...
[benchmarking](../architecture/benchmarking.md#methodology), since it's the operational policy the benchmarking
...
- **Would explaining it in [research and analysis](../research/research-and-analysis.md) actually be
