...
Rust production cutover plan](../../architecture/rust-production-cutover.md#0b-fuse-each-layer-operation-into-one-rust-call)'s
...
tier [an array-based Adam sibling](../adam/adam-array-layer.md#correctness-validation) established:
...
- `test_momentum_rust_array_layer.py`/`test_momentum_rust_array_multiclass_backprop_model.py` +
  ...
  sibling](../adam/adam-array-layer.md#the-rust-matmul-backed-counterpart)'s own stage 5.
