...
investigation](research-multiclass-and-loss.md#the-ensemblereal-mnist-investigation)), ahead of
...
([FanInAwareBackpropClassifierNetwork](structure.md#backprop-siblings)'s own docstring) and this
...
([the ensemble/real-MNIST
investigation](research-multiclass-and-loss.md#the-ensemblereal-mnist-investigation)). This also
...
nothing in [the Rust array core](rust-array-core.md) or [the production cutover
plan](rust-production-cutover.md) states whether it supports `pickle` at all - a real, untested
