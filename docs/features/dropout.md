...
The second item in [structure](../project/structure.md#possible-next-steps)'s "new model primitives" tier:
`L2RegularizedBackpropClassifierNetwork` is the only regularization this codebase has, and its
own measurement ([L2 weight
regularization](../research/research-backprop-siblings.md#l2-weight-regularization-closes-the-overfitting-gap-doesnt-improve-it))
...
setup](../research/research-backprop-siblings.md#l2-weight-regularization-closes-the-overfitting-gap-doesnt-improve-it)
...
[L2's](../research/research-backprop-siblings.md#l2-weight-regularization-closes-the-overfitting-gap-doesnt-improve-it)
