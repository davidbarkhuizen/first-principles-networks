...
- **Averaging, not summing, the batch gradient** (`grad / batch_size`) keeps `learning_rate`'s
  ...
  [the vectorized classes](../project/structure.md#vectorized-array-based-classes)' own
...
prerequisite for (but independent of) [the vectorized classes](../project/structure.md#vectorized-array-based-classes)'
own batched design.

## the momentum retest: settled, not just suggestive

`MomentumBackpropClassifierNetwork` exists and is tested, but was measured
(see [research and analysis](../research/research-backprop-siblings.md#momentum-measured-not-worth-adopting)) to
...
[research and analysis](../research/research-backprop-siblings.md#the-learning-rate-vs-batch-size-follow-up-the-confound-was-real-and-momentum-still-doesnt-help)
