...
[structure](structure.md#multi-class)). Built and measured; see [research and
analysis](research-multiclass-and-loss.md#an-array-based-softmax-sibling-the-retune-the-per-node-investigation-declined-to-spend-on)
