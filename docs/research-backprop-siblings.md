...
[a warmup schedule](learning-rate-schedule.md) - swept as `lr_schedule.linear_warmup(64.0,
...
core](rust-array-core.md#the-rng-exception)), on a fixed 400-example real-MNIST digit-3 proxy (320
