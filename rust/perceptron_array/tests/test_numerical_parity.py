...
from perceptron_array import Array, argmax, decode_mnist_pixels, exp, outer, sum_axis0, uniform

from perceptron.mnist_data import RECORD_SIZE, load_mnist_dataset_as_array
